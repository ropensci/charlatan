...
person_prefixes_female_en_us_messy <- c(
  person_prefixes_female_en_us,
  "Mrs", "Ms", "Miss.", "Dr"
)
person_prefixes_male_en_us <- c("Mr.", "Dr.")
person_prefixes_male_en_us_messy <- c(
  person_prefixes_male_en_us,
  "Mr", "Dr"
)

person_suffixes_female_en_us <- c("MD", "DDS", "PhD", "DVM")
person_suffixes_female_en_us_messy <- c(
  person_suffixes_female_en_us,
  "md", "m.d.", "d.d.s.", "Ph.D.", "dvm"
)
person_suffixes_male_en_us <- c(
  "Jr.", "Sr.", "I", "II", "III", "IV", "V",
  "MD", "DDS", "PhD", "DVM"
)
person_suffixes_male_en_us_messy <- c(
  person_suffixes_male_en_us,
