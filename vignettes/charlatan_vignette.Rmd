...
```{r}
testVec <- MissingDataProvider$new()
testVec$make_missing(x = mtcars$mpg)  #this command will add in random missing data using the mpg column from the mtcars dataset
```
